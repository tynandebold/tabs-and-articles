...
function Button(props) {
  return _react2.default.createElement(
    ...
    props.isBottom ? 'Move to top' : 'Move to bottom'
  );
}
...
var Content = function (_React$Component) {
  ...
  function Content(props) {
    ...
    _this.state = {
      active: true,
      index: _this.props.info[0].id,
      info: _this.props.info[0].info,
  ...
  _createClass(Content, [{
    key: 'handleClick',
    value: function handleClick(info, i) {
      this.setState({
        index: i,
        info: info
      });
    ...
    key: 'toggleLayout',
    value: function toggleLayout(props) {
    ...
    value: function render() {
      ...
      var tabs = this.props.info.map(function (tab, i) {
        return _react2.default.createElement(
          'span',
          { key: i,
            className: _this2.state.index === i ? "active" : "",
            onClick: function onClick(e) {
              return _this2.handleClick(tab.info, i);
            } },
          tab.name
        );
      });
      var bottomLayout = this.state.isBottom ? 'reverse' : '';

      return _react2.default.createElement(
        'div',
        { className: 'content-wrapper ' + bottomLayout },
        _react2.default.createElement(
          'div',
        ...
        _react2.default.createElement(
          'section',
          null,
          _react2.default.createElement(Paragraph, { content: this.state.info })
        ),
        _react2.default.createElement(Button, { onClick: this.toggleLayout, isBottom: this.state.isBottom })
      );
    }
  }]);
...
function App() {
  return _react2.default.createElement(Content, { info: content });
}
